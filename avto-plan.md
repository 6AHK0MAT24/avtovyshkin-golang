...
### 3. Модели (internal/models/vehicle.go)
...
### 4. Repository (internal/repository/vehicle_repository.go)
...
### 5. Service (internal/service/vehicle_service.go)
...
### 6. Handler (internal/handler/vehicle_handler.go)
...
### 7. WebSocket (internal/websocket/)
...
### 14. Заполнение данными (migrations/002_insert_initial_vehicles.sql)
...
- Использование существующих путей изображений из constants.ts (поля img)
### 15. Тестирование
