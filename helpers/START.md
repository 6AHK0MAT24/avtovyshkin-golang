...
Останавливает процессы на портах 8082 и 5173, опционально останавливает PostgreSQL.
...
### Освобождение портов
Если порты 8082 или 5173 уже заняты, скрипты попытаются освободить их автоматически.
...
Запускает backend сервис в Docker на порту 8082.
...
### `start-backend.ps1` - Запуск только Backend
Запускает backend сервис на порту 8082.
